...
if os.environ.get("BORING_M68_ALLOW_FRAMEBUFFER_CORE") != "1":
    frozen_paths.add("kernel/core/framebuffer.c")
bad = sorted(path for path in changed if path in frozen_paths)
if bad:
