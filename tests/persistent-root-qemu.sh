...
start_vm first
for line in 'BoringKernel 0.0.54-dev' '  mount-at-root: PASS' 'BoringFS root mounted.' 'boring-init: pid 1' 'boring-shell: pid 2' 'boring-shell ready.'; do
...
send 'uname'
grep -Fqx 'BoringOS BoringKernel 0.0.54-dev x86_64' "${LOG}" || fail 'uname identity mismatch'
...
send 'boringfetch'
for line in '    ____             BoringOS' '  / __  / __ \/ ___/ OS: BoringOS' ' / /_/ / /_/ / /    Kernel: BoringKernel 0.0.54-dev' '/_____/\____/_/      Arch: x86_64' '                     Hostname: boringos' '                     User: boring' '                     Shell: boring-shell' '                     Root FS: BoringFS' '                     Root device: virtio-blk' '                     Processes: 3' '                     PID: 5'; do
